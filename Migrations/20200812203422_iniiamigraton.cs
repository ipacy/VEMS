...
{
    public partial class iniiamigraton : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatePolicy = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    CreatedDate = table.Column<DateTime>(nullable: false),
                    UserExamId = table.Column<Guid>(nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserExams_ApplicationUserId",
                table: "UserExams",
